      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
        <div className="relative border-t border-gray-900/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
          <div className=" flex flex-col items-center md:items-start">
            ...
            <address className="not-italic text-slate-700 space-y-0 text-sm mt-1 mb-2 text-center">
              <p className="flex text-center md:text-start gap-3">
            ...
            <div className="not-italic text-slate-700 space-y-0 text-sm my-1">
              <div className="flex flex-col  gap-2  justify-between md:mr-20">
                <div className="flex flex-col md:flex-row md:items-start items-center gap-2">
                  <p className="w-[3rem]">Phone:</p>
                  <div className="flex flex-col">
                    <a
                      href="tel:+13055550456"
                      className="hover:underline text-[hsl(185,65%,35%)]"
                    >
                      (305) 555-0456
                    </a>
                    <a
                ...
                <div className="flex flex-col md:flex-row md:items-start items-center gap-2">
                  <p className="">Fax: </p>
                  <span className="text-[hsl(185,65%,35%)]">
                    (305) 555-0789
                  </span>
                </div>
              </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 xl:col-span-2 xl:mt-0 md:ml-20 text-center">
